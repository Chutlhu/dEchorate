...
# python dechorate/main_build_sound_datasets.py --outdir ${outdir} --signal silence --datadir $path_to_data_dir --dbpath $path_to_database
# python dechorate/main_build_sound_datasets.py --outdir ${outdir} --signal babble  --datadir $path_to_data_dir --dbpath $path_to_database
# python dechorate/main_build_sound_datasets.py --outdir ${outdir} --signal noise   --datadir $path_to_data_dir --dbpath $path_to_database
# python dechorate/main_build_sound_datasets.py --outdir ${outdir} --signal speech  --datadir $path_to_data_dir --dbpath $path_to_database
# python dechorate/main_build_sound_datasets.py --outdir ${outdir} --signal chirp   --datadir $path_to_data_dir --dbpath $path_to_database
# echo "you may want to delete the content of .cache folder" 

# # # 5. Estimate RIRs
# path_to_chirps="${outdir}/dEchorate_chirp.hdf5"
# python dechorate/main_estimate_rirs.py --outdir ${outdir} --dbpath $path_to_database --chirps $path_to_chirps

# # # 6. Convert it into Sofa format
# python dechorate/main_build_sofa_database.py  --outdir ${outdir} --toa "$path_to_data_dir/echo_pickpeaking.csv" --csv "${outdir}/dEchorate_database.csv" --hdf "${outdir}/dEchorate_rirs.hdf5"
